...
const studentAuthController = require("../../controllers/stdent/student_auth_controller");
...
//login
router.post("/login", studentAuthController.loginController);
router.post("/change-password/", utils.extractStudentToken, studentAuthController.changePasswordController);
